...
cstr_model.root.input['return'].unit_001.split_components_data = 0
cstr_model.root.input['return'].unit_001.split_ports_data = 0
cstr_model.root.input['return'].unit_001.write_solution_bulk = 1
cstr_model.root.input['return'].unit_001.write_solution_inlet = 1
cstr_model.root.input['return'].unit_001.write_solution_outlet = 1
cstr_model.root.input['return'].unit_001.write_solution_solid = 1

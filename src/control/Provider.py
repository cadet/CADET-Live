...
class TimeDependentData:
    ...
    def __init__(self,
                 ...
                 state_index: Optional[int] = None #for cadet model, this is the index in the full state vector
                ):
        self.name = name
...
class DFProvider(MeasurementProvider):
    ...
    def _parse_dataframe(self, noise: Optional[Union[np.ndarray, Dict[str, np.ndarray]]]):
...
if __name__ == "__main__":
    print("=== Example 1: Basic TimeDependentData ===")
